...
function PlayerSearchPage() {
    ...
    const fetchAllPlayers = async () => {
      try {
        ...
        const response = await fetch(
          `${import.meta.env.VITE_API_URL}/players/all`
        );
  ...
  return (
    <section className="page-section players-page">
      <div className="players-page-inner">
        ...
        {playerData && (
          <button className="back-button" onClick={handleBackToTopPlayers}>
            Back to Top Players
          </button>
        )}
        ...
        <div className="player-results">
          ...
          {!error && !playerData && !playerName.trim() && (
            <div className="player-browser">
              <h2>Featured Players</h2>

              {isLoadingPlayers ? (
                <p>Loading featured players...</p>
              ) : (
          ...
          {!error && !playerData && playerName.trim() && (
            <p>Press search or hit Enter to look up a player.</p>
          )}
